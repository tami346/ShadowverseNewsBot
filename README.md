...
- Ver.0.1.8 (2022/04/17)
  - 使用するPythonのバージョンを3.8から3.10に変更
- Ver.0.1.7 (2020/03/19)
  - 使用するPythonのバージョンを3.7から3.8に変更
- Ver.0.1.6 (2019/10/28)
  - ニュースページの新しいURL表記に対応
- Ver.0.1.5 (2019/04/21)
  - requirements.txtではなくpipenv仮想環境のPipfileを使うように変更
